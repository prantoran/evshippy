...
func (*Consignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_2097198a1da610e9, []int{0}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_2097198a1da610e9, []int{1}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_2097198a1da610e9, []int{2}
}
...
func init() {
	proto.RegisterFile("proto/consignment/consignment.proto", fileDescriptor_consignment_2097198a1da610e9)
}

var fileDescriptor_consignment_2097198a1da610e9 = []byte{
